...
public class DbSearchServiceImpl implements SearchService {
    ...
    public RestResp<PageRespDto<BookInfoRespDto>> searchBooks(BookSearchReqDto condition) {
        Page<BookInfoRespDto> page = new Page<>(); // MP的分页
        page.setCurrent(condition.getPageNum()); // 当前页
        page.setSize(condition.getPageSize()); // 一页的大小
        List<BookInfo> bookInfos = bookInfoMapper.searchBooks(page, condition); // 在XML中自定义查询
        return RestResp.ok(
